...
# -*- coding: utf-8 -*-
#
# dman documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'dman.tex', 'dman Documentation',
     'Peter Coppens', 'manual'),
]
...
man_pages = [
    (master_doc, 'dman', 'dman Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dman', 'dman Documentation',
     author, 'dman', 'One line description of project.',
     'Miscellaneous'),
]
